/*
This class test all the functionality of the shape hierarchy.
It checks the working of the following shapes by drawing a
house using early as well as late binding on canvas:
-> Rectangle
-> Rhombus
-> Oblique triangle
-> Right triangle
